...
Once the skeleton is working, common next moves are:

1. Add real HTTP routes or additional triggers
2. Introduce Key Vault only when you actually need secrets
